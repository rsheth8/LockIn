...
final class DemoTourController: ObservableObject {
    ...
    let steps: [DemoTourStep] = [
        ...
        DemoTourStep(tab: 2, title: "That's the whole app", body: "Sign-in, a quiz-driven onboarding, and everything you just clicked through — all built on 128 tests covering the metabolic math, meal assembly, scheduling, and accountability copy. Tap Exit demo any time to get back to your own account.")
    ]
